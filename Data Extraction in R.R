...
#like c1, c2, c3, c4, c5
write.csv(x=mtcars, file='C:/Users/Dell/Documents/data/mtcars1.csv')
write.csv(x=mtcars, file='C:/Users/Dell/Documents/data/mtcars2.csv', row.names = F)
...
# Method 2:
c_1 <- read.csv("C:/Users/Dell/Documents/data/mtcars1.csv")
View(c_1)

newmtcars1 = read.csv(file='C:/Users/Dell/Documents/data/mtcars2.csv')
head(newmtcars1)
#no car names