...
Plan_Dataset <- read.csv("C:/Users/Dell/Downloads/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
setwd("C:/Users/Dell/Downloads")
sm2 <- read.csv("C:/Users/Dell/Downloads/InsurancePlanSubscriptions-2018.csv")
View(sm2)
